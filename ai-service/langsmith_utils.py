"""
LangSmith observability layer for ARIA.
...
To enable:
  ...
  LANGCHAIN_PROJECT=ARIA-Production
"""
...
logger = logging.getLogger("aria.langsmith")

_API_KEY = os.environ.get("LANGCHAIN_API_KEY", "")
_TRACING  = os.environ.get("LANGCHAIN_TRACING_V2", "").lower() == "true"
_PROJECT  = os.environ.get("LANGCHAIN_PROJECT", "ARIA-Production")
